...
public class MainActivity extends AppCompatActivity {
    ...
    private void pintarElementos() {
        ...
        for (Alumno alumno : alumnosList) {
            // Contruir Layout para cada fila de alumnos
            View alumnoView = LayoutInflater.from( MainActivity.this).inflate(R.layout.alumno_model_view,null);
            // Tomo posesion de los elementos de la vista de la fila alumno
            TextView lbNombre = alumnoView.findViewById(R.id.lbNombreAlumnoModelView);
            TextView lbApellidos = alumnoView.findViewById(R.id.lbApellidosAlumnoModelView);
            TextView lbCiclo = alumnoView.findViewById(R.id.lbCicloAlumnoModelView);
            TextView lbGrupo = alumnoView.findViewById(R.id.lbGrupoAlumnoModelView);
            lbNombre.setText(alumno.getNombre());
            lbApellidos.setText(alumno.getApellidos());
            lbCiclo.setText(alumno.getCiclo());
